    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('admin', 'Admin'), ('cashier', 'Cashier'), ('kitchen', 'Kitchen Staff')], default='cashier', max_length=20)),
                ...
                ('outlet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='tenants.outlet')),
            ],
            options={
                'verbose_name': 'User',
