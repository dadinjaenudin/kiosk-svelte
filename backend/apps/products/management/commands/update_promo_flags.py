"""
Management command to update existing products with promo/popular flags
Usage: python manage.py update_promo_flags
Note: Run 'seed_foodcourt' first to create products
"""
...
class Command(BaseCommand):
    help = 'Update existing products with promo/popular flags for search features'
