"""
Django settings for POS F&B System
"""
import os
...
# Database
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgresql://pos_user:pos_password_2024@localhost:5432/pos_db')
}
...
XENDIT_CALLBACK_TOKEN = env('XENDIT_CALLBACK_TOKEN', default='')
